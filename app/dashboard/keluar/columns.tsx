...
import { updateKeluar, deleteKeluar } from "@/app/actions"
...
export const columns: ColumnDef<Keluar>[] = [
  {
    accessorKey: "number",
    header: "No.",
  ...
  },
  {
    ...
    cell: ({ row }) => {
      const jumlah = row.original.jumlahKeluar
          ...
          <Dialog>
            ...
            <DialogContent className="sm:max-w-[425px]">
              <DialogHeader>
                ...
                <DialogDescription>Ubah data barang keluar.</DialogDescription>
              </DialogHeader>
              <form action={updateKeluar}>
                <input type="hidden" name="id" value={keluar.id} />
                <div className="grid gap-4 py-4">
                  <div className="grid grid-cols-4 items-center gap-4">
                    <Label htmlFor="jumlahKeluar" className="text-right">
                      Jumlah
                    </Label>
                    <Input
                      id="jumlahKeluar"
                      name="jumlahKeluar"
                      type="number"
                      defaultValue={keluar.jumlahKeluar}
                  ...
                  <div className="grid grid-cols-4 items-center gap-4">
                    ...
                    <Input
                      ...
                      type="date"
                      defaultValue={
                        new Date(keluar.tanggal).toISOString().split("T")[0]
                      }
                      className="col-span-3"
                      required
                    />
